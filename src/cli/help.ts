...
export function rootHelp(operations: OperationDescriptor[]): string {
  ...
  return [
    ...
    "Utility groups: auth, operation, setup",
    "",
    "Global options:",
    ...
    "  --dry-run                 Validate a mutation without auth/network",
...
export function groupHelp(group: string[], operations: OperationDescriptor[]): string {
  ...
  if (name === "setup") {
    return [
      ...
      "",
      "Commands:",
      "  codex    Idempotently install a repo-local skill and SessionStart home hook",
      "  remove   Remove only the integration generated by this CLI",
      "",
